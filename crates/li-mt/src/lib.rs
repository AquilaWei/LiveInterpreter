//! Translation, English to Traditional Chinese (Taiwan) — PLAN §2.4.
//!
...
//!
//! ## What task 1.6 measured
//!
//! The Phase 0 PoC's MT path was a single call per finalised line. On the
...
//! |---|---|---|---|
//! | one call per line, beam 1 (Phase 0's settings) | 9.9 | 15.2 | 70% / 18% |
...
//! is the number the design is built on. Details in
...
pub trait Translator: Send + Sync {
    ...
    /// backend can be swapped at run time (PLAN §14).
